	...
	<div class="widgetcontent wc1">
		<form id="form1" class="stdform" method="post" action="empresa-puestos">
			<table style="width: 100%" id="dataCompany">
				<tbody>
					<tr>
						<td style="width: 50%;"><?php showInput($datos[0], "Departamento", "departamento"); ?></td>
						<td style="width: 50%;"><?php showInput($datos[0], "Categoría", "categoria"); ?></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "Titulación académica", "titulacion_academica"); ?></td>
						<td><?php showInput($datos[0], "Otras preparaciones y capacidades", "otras_preparaciones"); ?></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "Personas a admitir", "personas_admitir"); ?></td>
						<td><?php showInput($datos[0], "Personas a darles salida", "personas_salida"); ?></td>
					</tr>
					<tr>
						<td><?php showSelect($datos[0], "Lugar de trabajo", "lugar_trabajo", $sedes); ?></td>
...
function showInput($datos, $label, $name, $type = "text", $class="input-large", $simbol = "", $err = Array()){
	...
	?>
	<div class="par control-group <?php echo $color; ?>" style="margin: 5px 0;">
...
function showSelect($datos, $label, $name, $array, $default = ""){
	...
	<div class="par control-group <?php echo $color; ?>" style="margin: 5px 0;">
		...
		<span class="formwrapper">
			<select data-placeholder="<?php echo $label; ?>" name="<?php echo $name; ?>" class="chzn-select" tabindex="2">
