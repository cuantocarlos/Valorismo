	...
	if(isset($_POST["guardarprofile"])){
		if($cusers->is_demo == "0"){
			if($cusers->rol == 1){
				...
				if(isset($_POST["provincia"]) && is_numeric($_POST["provincia"])) $data["provincia"] = $sql->fstr($_POST["provincia"]);
	...
	<div class="widgetcontent wc1">
		<form id="form1" class="stdform" method="post" action="miperfil" enctype="multipart/form-data">
				...
				if($cusers->rol == 1){
					...
					<table width="100%;">
						<tr>
							<td><?php showInput($datos[0], "Nombre", "nombre"); ?></td>
							<td><?php showInput($datos[0], "Apellidos", "apellidos"); ?></td>
						</tr>
						<tr>
							<td><?php showInput($datos[0], "Dirección", "direccion"); ?></td>
							<td><?php showInput($datos[0], "Código Postal", "cp"); ?></td>
						</tr>
						<tr>
							<td><?php showInput($datos[0], "Localidad", "localidad"); ?></td>
							<td><?php showSelect($datos[0], "Provincia", "provincia", $provincias); ?></td>
						</tr>
						<tr>
							<td><?php showInput($datos[0], "DNI", "dni"); ?></td>
							<td><?php showInput($datos[0], "Email", "email"); ?></td>
						</tr>
						<tr>
							<td><?php showInput($datos[0], "Teléfono", "telefono"); ?></td>
							<td><?php showInputT($datos[0], "Descripción", "descripcion"); ?></td>
						</tr>
						<tr>
							<td><?php showRadio($datos[0], "Estado", "estado", $estados); ?></td>
							<td><?php showRadio($datos[0], "Ofertas de empleo", "ofertas", $ofertas); ?></td>
						</tr>
						<tr>
							<td><?php showUpload("Subir Foto", "img_user"); ?></td>
					...
					<table width="100%">
						...
						<tr>
							<td><?php showInput($datos[0], "Domicilio social", "domicilio_social"); ?></td>
							<td><?php showInput($datos[0], "CIF", "cif"); ?></td>
						</tr>
						<tr>
							<td><?php showSelect($datos[0], "Provincia", "provincia", $provincias); ?></td>
							<td><?php showSelect($datos[0], "CNAE", "cnae", $cnaes); ?></td>
						</tr>
						<tr>
							<td><?php showUpload("Subir Foto", "img_user"); ?></td>
							<td><p class="stdformbutton">
...
if($cusers->rol == 2 && $sedes){
	...
	<div class="widgetbox" id="asedes">
		...
		<div class="widgetcontent wc1">
			...
			?>
			<div class="widgetbox span5" style="width: 46%;">
			...
			<div class="widgetbox span5" style="width: 46%;">
				<?php $rows = $sql->runSelect("empresario_sedes", "id_empresa = '".$cusers->id_perfil."'", "*", false, false, false, false, false, false); ?>
...
?>
<div class="widgetbox span5" id="pass">
...
function showInput($datos, $label, $name, $type = "text", $class="input-large"){
	...
	?>
	<div class="par control-group <?php echo $color; ?>" style="margin: 0px 0;">
		<label class="control-label" for="<?php echo $name; ?>"><?php echo $label; ?></label>
		<div class="controls"><input type="<?php echo $type; ?>" name="<?php echo $name; ?>" id="<?php echo $name; ?>" class="<?php echo $class; ?> span3" placeholder="<?php echo $label; ?>" value="<?php echo $default; ?>" /><?php echo $msg; ?></div>
	</div>
	<?php
}
...
function showInputT($datos, $label, $name, $type = "text", $class="input-large"){
	...
	<div class="par control-group <?php echo $color; ?>" style="margin: 0px 0;">
		<label class="control-label" for="<?php echo $name; ?>"><?php echo $label; ?></label>
		<div class="controls">
			<textarea name="<?php echo $name; ?>" id="<?php echo $name; ?>" class="<?php echo $class; ?> span3" placeholder="<?php echo $label; ?>"><?php echo $default; ?></textarea><?php echo $msg; ?>
		</div>
	</div>
	<?php
}
...
function showUpload($label, $name){
	?>
	<div class="par" style="margin: 0px 0;">
		<label><?php echo $label; ?></label>
		<div class="fileupload fileupload-new" data-provides="fileupload">
		<div class="input-append span2" style="margin: 0px 0;">
		<div class="uneditable-input span2">
			<i class="iconfa-file fileupload-exists"></i>
			<span class="fileupload-preview"></span>
		</div>
		<span class="btn btn-file"><span class="fileupload-new" style="font-size: 9px;">Seleccionar archivo</span>
...
function showSelect($datos, $label, $name, $array, $default = ""){
	...
	<div class="par control-group <?php echo $color; ?>" style="margin: 0px 0;">
		...
		<span class="formwrapper">
			<select data-placeholder="<?php echo $label; ?>" name="<?php echo $name; ?>" class="chzn-select span3" tabindex="2">
			  <option value=""></option>
			  <?php
			  $open = false;
