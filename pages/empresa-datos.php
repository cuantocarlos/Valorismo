...
<form id="form1" class="stdform" method="post" action="empresa-datos">
	<div class="widgetbox box-inverse" style="width: 100%;">
		...
		<div class="widgetcontent wc1">
			<table style="width: 100%">
				<tbody>
					<tr>
						<td colspan="2" style="text-align: center;">
							<h3>
								...
								<div class="controls input-append <?php echo $dateerr; ?>"><input id="datepickercool" type="text" name="date" class="input-large date-picker" /></div>
							</h3>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><h2 style="text-align: center;">Valores a Introducir</h2></td>
						<td><h2 style="text-align: center;">Valor Resultante</h2></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "Valor empresarial", "valor_empresarial", "text", "input-large", "€"); ?></td>
						<td></td>
					</tr>
					<tr>
						<td></td>
						<td><?php showDefault(seeNum2($sector), "%del Sector", "porc_sector", "% Según el INE del Sector", "%"); ?></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "% Valor Social", "valor_social_p", "text", "input-large", "%", $err); ?></td>
						<td><?php showDefault(seeNum2($valor_social), "Valor Social", "valor_social", "Valor Empresarial x % del Valor Social", "€"); ?></td>
					</tr>
					<tr>
						<td></td>
						<td><?php showDefault(seeNum2($base_imponible), "Base Imponible", "base_imponible", "Valor Empresarial + Valor Social", "€"); ?></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "% IVA", "iva_p", "text", "input-large", "%"); ?></td>
						<td><?php showDefault(seeNum2($iva), "IVA", "iva", "Base Imponible x % IVA", "€"); ?></td>
					</tr>
					<tr>
						<td></td>
						<td><?php showDefault(seeNum2($ventas_totales), "Ventas Totales", "ventas_totales", "Valor Empresarial + Valor Social + IVA", "€"); ?></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "Importe total de las nóminas", "importe_nominas", "text", "input-large", "€"); ?></td>
						<td><?php showDefault(seeNum2($resto_nominas), "Resto de las nóminas", "resto_nominas", "Valor Social - Importe Nóminas", "€"); ?></td>
					</tr>
					<tr>
						<td></td>
						<td><?php showDefault(seeNum2($resto_acumulado), "Resto acumulado (meses anteriores)", "resto_acumulado", "Suma del resto de las nominas de todos los meses anteriores", "€"); ?></td>
					</tr>
					<tr>
						<td><?php showInput($datos[0], "Nº Trabajadores", "num_trabajadores", "text", "input-large", "Tr"); ?></td>
						<td><?php showDefault(seeNum2($coste_sal_medio), "Coste Salarial Medio", "coste_sal_medio", "Imp. Nóminas / Nº Trabajadores", "€"); ?></td>
					</tr>
					<tr>
						<td colspan="2"><input type="submit" name="guardarprofile" class="btn btn-primary" value="Guardar Cambios" /></td>
					</tr>
				</tbody>
			</table>
		</div><!--widgetcontent-->
	...
	<div class="widgetcontent wc1">
		...
		jQuery(document).ready(function(){
			...
			jQuery("#valor_empresarial").change(function() {
				...
				jQuery('#resto_nominas').val((Number(jQuery("#valor_social").val())-Number(jQuery("#importe_nominas").val())).toFixed(2));
			});
			...
			jQuery("#importe_nominas").change(function() {
				jQuery('#resto_nominas').val((Number(jQuery("#valor_social").val())-Number(jQuery("#importe_nominas").val())).toFixed(2));
				jQuery('#coste_sal_medio').val((Number(jQuery("#importe_nominas").val()) / Number(jQuery("#num_trabajadores").val())).toFixed(2));
			});
		...
		<table id="dyntable" class="table table-bordered responsive">
			<thead>
				<tr>
					...
					<th class="row_cus">IVA</th>
					<th class="row_cus">Imp. Nominas</th>
					<th class="row_cus">Resto Nominas</th>
			...
			<tbody>
				...
				for($x=0; $x<count($rows); $x++){
					...
					<tr>
						...
						<td class="row_cus"><?php echo seeNum($rows[$x]["resto_nominas"]); ?> €</td>
